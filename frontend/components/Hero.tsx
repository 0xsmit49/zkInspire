...
export default function HeroSection() {
  ...
  <div className="space-y-4 max-w-xl mx-auto">                 
    <p className="text-xl lg:text-2xl xl:text-3xl text-white/100 leading-relaxed font-medium drop-shadow-md">                   
    Introducing Proof Of Inspiration . 
    </p>                 
